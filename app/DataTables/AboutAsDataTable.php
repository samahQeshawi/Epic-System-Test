...
class AboutAsDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', 'dashboard.about-us.actions')
     ...
     *
     * @param \App\Models\AboutAs $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(AboutAs $model): QueryBuilder
    {
