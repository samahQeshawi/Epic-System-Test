    ...
    <div class="card-body">
        <div class="row">
            <div class="media mb-2">
                <img src="{{@$design->image ? @$design->image : url('app_img/ChoosePhoto.png') }}" alt="Banner Image"
...
{{--    <x-file title="الصورة" name="image"  size="12" :options="['accept'=>'image/*']"></x-file>--}}
    <x-translatable title="الاسم" name="name" :item="@$design"   size="6"></x-translatable>
    <x-translatable-textarea title="التفاصيل" name="details" :item="@$design"  size="6"></x-translatable-textarea>


</div>
<button type="submit" class="btn btn-success mr-1 mb-1 waves-effect waves-light">حفظ</button>
<a href="{{route('designs.index')}}" class="btn btn-primary mr-1 mb-1 waves-effect waves-light">رجوع</a>
